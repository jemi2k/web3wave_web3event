...
<nav className="bg-white dark:bg-gray-900 fixed w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
  ...
  <a href="#" className="flex items-center space-x-3 rtl:space-x-reverse">
      ...
      <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Web3Wave</span>
  </a>
  ...
  <div className="items-center justify-around hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
    ...
    md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
      ...
      {/* <div classNameName='nav__brand'>
        <h1>tokenmaster</h1>

        <input classNameName='nav__search' type="text" placeholder='Find millions of experiences' />
